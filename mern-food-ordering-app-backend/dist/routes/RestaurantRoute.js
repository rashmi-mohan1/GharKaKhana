...
router.get("/:restaurantId", (0, express_validator_1.param)("restaurantId")
    ...
    .trim()
    .notEmpty()
    .withMessage("RestaurantId paramenter must be a valid string"), RestaurantController_1.default.getRestaurant);
router.get("/search/:city", (0, express_validator_1.param)("city")
    .isString()
    .trim()
    .notEmpty()
    .withMessage("City paramenter must be a valid string"), RestaurantController_1.default.searchRestaurant);
